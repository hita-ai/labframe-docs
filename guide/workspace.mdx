---
title: Workspace
description: Browse, preview, upload, and download files on your agent's dedicated computer.
---

Every agent's dedicated computer has a persistent filesystem. Files your agent creates — code, documents, datasets, build output — are stored here and survive across sessions. Nothing resets when the conversation ends.

Switch to the **Workspace** tab in any agent view to browse your agent's computer.
...
Browsing the workspace requires the agent's computer to be running. If the agent is asleep, you will see a message prompting you to **Wake** the agent before accessing files.
