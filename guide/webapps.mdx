---
title: Web Apps
description: Your agent builds websites on its dedicated computer and LabFrame deploys them to a public URL you can share with anyone.
---

When you ask your agent to build a website, it writes the code on its dedicated computer, packages the result as a `.webapp` artifact, and LabFrame deploys it to a public URL.
